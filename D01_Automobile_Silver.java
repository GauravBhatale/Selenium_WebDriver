...
public class D01_Automobile_Silver {
  ...
  //SELECT PRICE OPTION
       String expPrice = "293.00" ,expClaim = "No", expDis = "No",expCover = "No",actPrice,actClaim,actDis,actCover;
        ...
        System.out.println("Clicking Automobile - Silver Values");
       ...
       // driver.findElement(By.name("")).click();
        ...
        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"priceTable\"]/tfoot/tr/th[2]/label[1]/span")));
        element.click();
