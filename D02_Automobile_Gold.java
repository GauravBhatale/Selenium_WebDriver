...
public class D02_Automobile_Gold {
  ...
  //SELECT PRICE OPTION
       String expPrice = "293.00" ,expClaim = "No", expDis = "No",expCover = "No",actPrice,actClaim,actDis,actCover;
        ...
        System.out.println("Clicking Automobile - Gold Values");
        ...
        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"priceTable\"]/tfoot/tr/th[2]/label[2]/span")));
        element.click();
