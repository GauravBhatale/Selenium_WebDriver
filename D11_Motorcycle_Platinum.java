...
public class D11_Motorcycle_Platinum {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		driver.findElement(By.id("cylindercapacity")).sendKeys("11");
		driver.findElement(By.id("engineperformance")).sendKeys("444");
		driver.findElement(By.id("dateofmanufacture")).sendKeys("10/10/2025");
		new Select(driver.findElement(By.id("numberofseatsmotorcycle"))).selectByVisibleText("3");
		driver.findElement(By.id("listprice")).sendKeys("2222");
		...
		System.out.println("Clicking Motorcycle - Platinum Values");
